...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        @user = test_sign_in(User.make!)
        User.make!(:email => "another@example.com")
        User.make!(:email => "another@example.net")
  ...
  describe "GET 'show'" do
    ...
    it "should show the user's microposts" do
      mp1 = Micropost.make!(:user => @user, :content => "Foo bar")
      mp2 = Micropost.make!(:user => @user, :content => "Baz quux")
      get :show, :id => @user
    ...
    it "should paginate microposts" do
      35.times { Micropost.make!(:user => @user, :content => "Foo bar") }
      get :show, :id => @user
      response.should have_selector('div.pagination')
    end
    
    it "should display the micropost count" do
      10.times { Micropost.make!(:user => @user, :content => "Foo bar") }
      get :show, :id => @user
  ...
  describe "authentication of edit/update actions" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        wrong_user = User.make!(:email => "user@example.net")
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      before(:each) do
        @admin = User.make!(:email => "admin@example.com", :admin => true)
        test_sign_in(@admin)
      end
