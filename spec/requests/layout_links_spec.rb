...
describe "LayoutLinks" do
  ...
  describe "when not signed in" do
    it "should have a signin link" do
      visit root_path
      response.should have_selector('a', :href => '/signin', :content => "Sign in")
    end
  end
  ...
  describe "when signed in" do
    ...
    it "should have a signout link" do
      visit root_path
      response.should have_selector('a', :href => '/signout', :content => "Sign out")
    end
    ...
    it "should have a userss link" do
      visit root_path
